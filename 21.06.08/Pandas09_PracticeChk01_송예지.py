...
deptList
for i in deptList:
    grDept=sawonDB[sawonDB['deptno']==30]
print('전산부 직원의 평균연봉은 %.2f만원 입니다.'%grDept['sapay'].mean())
...
for i in deptList:
    grDept=sawonDB[sawonDB['deptno']==30]
print('전산부 직원의 인상된 평균연봉은 %.2f만원 입니다.'%grDept['changed_sapay'].mean())
...
sorted_sawonDB2=sawonDB.sort_values('sabun')
sorted_sawonDB2
...
sorted_sawonDB3=sawonDB.sort_values('deptno')
sorted_sawonDB3
